    ...
    <div className="p-4 md:p-6 max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 md:p-5">
          <h2 className="font-bold text-gray-700 mb-3">Ảnh sản phẩm</h2>
          <div className="flex gap-4 items-start">
            <div
              onClick={() => fileRef.current.click()}
              className="w-32 h-24 md:w-40 md:h-32 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all flex-shrink-0 overflow-hidden bg-gray-50">
              {imagePreview ? (
                <img src={imagePreview} alt="" className="w-full h-full object-cover" />
              ) : (
                <>
                  <svg className="w-7 h-7 text-gray-300 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                  </svg>
                  <span className="text-xs text-gray-400 text-center px-2">Chọn ảnh</span>
                </>
              )}
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 md:p-5 space-y-3">
          ...
          {/* Brand + Model: stack on mobile, side by side on sm+ */}
